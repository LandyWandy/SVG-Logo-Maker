...
describe('generateSVG', () => {
  test('should generate SVG for circle with text', () => {
    ...
    expect(svg).toContain('<text x="150" y="105" font-size="48" text-anchor="middle" fill="black">A</text>');
  });
  ...
  test('should generate SVG for triangle with text', () => {
    ...
    expect(svg).toContain('<text x="150" y="105" font-size="48" text-anchor="middle" fill="black">B</text>');
  });
  ...
  test('should generate SVG for square with text', () => {
    ...
    expect(svg).toContain('<text x="150" y="105" font-size="48" text-anchor="middle" fill="black">C</text>');
  });
});
